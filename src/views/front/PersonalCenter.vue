<template>
  <div class="personalCenterView">
    ...
    <div class="topbar">
      ...
      <div class="userBaseInfor">
        ...
        <div class="avaOfPersonalCenter">
          <div class="avatarOfUser"
               style="width: 100px;height: 100px;position: relative;top: -30px">
            <img :src="personalInfor.avatarUrl"
        ...
        <div class="baseInformation">
          ...
          <div class="nicknameOfpersonal"
            ...
            <span class="el-icon-message"
                  style="padding-left: 15px;font-size: 12px;"></span>
            <span style="flex: 13;line-height: 47px;padding-left: 5px;color: #222226; font-size: 12px;color: #999AAA">{{personalInfor.email}}</span>
          </div>
          <!--                    数据显示区域-->
          <div class="dataView"
               style="color: #999aaa; flex: 1;display: flex;justify-content: center;align-items: center;font-size: 14px;letter-spacing: 1px;">
            <div>
              <span> {{personalInfor.count}}</span>文章数量
            </div>
            <div>
              <span> {{readNumber}}</span>被浏览量
            </div>
            <div>
              <span>{{collectedNumber}}</span>被收藏量
            </div>
          ...
          <div class="collapse_view"
               style="flex:1;margin-left: 10px;background-color: black;color: #555666">
            <el-collapse accordion>
              <el-collapse-item title="点击查看更多信息"
                                name="1"
                                style="background-color:#555666 ;">
        ...
        <div class="buttonArea">
          <el-button v-if="id==user.id"
                     class="el-icon-tickets"
                     round
                     type="primary"
                     style="  letter-spacing: 1px;height: 40px"
                     @click="pushIntoEditView">编辑资料</el-button>
        </div>
      </div>
    </div>
    ...
    <div class="resourcesOfPersonal">
      ...
      <div class="resources">
        <div>
          <el-menu :default-active="'/front/personalCenter/newArticleOfPersonal'"
                   class="el-menu-demo"
                   mode="horizontal"
                   router>

            <el-menu-item index="/front/personalCenter/newArticleOfPersonal"
                          :route="{name:'NewArticleOfPersonal',query:{id:this.id}}">最新文章</el-menu-item>
            <!-- <el-menu-item index="/front/personalCenter/newResoucesView"
                          :route="{name:'NewResoucesView',query:{id:this.id}}">最新资源</el-menu-item> -->
...
.personalCenterView {
  ...
  align-items: center;
  height: 1000px;
  background-image: url('~@/assets/person-whole-bk.gif');
}
.topbar {
  width: 2000px;
  flex: 3;
