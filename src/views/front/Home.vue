    ...
    <div style="width: 70%;height: 100%;float: left; background-color:#FAFAFA">
      ...
      <div style="height: 45%;width: 100%;background-color:#FAFAFA;margin-top: 10px">
        ...
        <div class="newRecommend"
             style="width: 50%;height: 100%;float: left;background-color: #FAFAFA; border: 1px solid #efefef;">
          <div class="recommend"
               style="height: 30px; margin-top: 10px;width: 100%;background-color: #FAFAFA">
            <div class="putImg"><img src="~@/assets/recomand.png"></div>
            <span>推荐</span>
          </div>
              ...
              <div>
                <el-carousel :interval="5000"
                  ...
                  <el-carousel-item v-for="item in carousels"
                                    :key="item.id">
                    <img :src="item.url"
                         style="clip: rect(0px,800px,800px,0px);width: auto;height: auto;min-height: 100%;min-width: 100%; background-repeat: no-repeat;background-position: center;position: absolute;z-index: 2;background-size:cover;">
        ...
        <div class="newArticle"
             style="width: 50%;height: 100%;float: left;background-color:#FAFAFA; border: 1px solid #efefef;">
          <div class="title_1"
               style="height: 30px;width: 100%;margin-top: 10px;background-color: #FAFAFA">
            <div class="img_article"></div>
            <span>最新文章</span>
          </div>
          <div class="article_1"
               style="margin-top: 5px;height: 400px;width: 100%;">

            <div class="theTitleOfArticle"
...
overflow: hidden;color: #000; font-weight: normal"
      ...
      <div style="height: 51%;width: 100%;background-color: rgb(245,246,247);margin-top: 10px;margin-bottom: 30px">
        <div>
          <el-menu :default-active="'/front/home/recomandArticleOfHomeView'"
                   class="el-menu-demo"
                   mode="horizontal"
                   router
                   @select="handleSelect">
...
.guanggao {
  ...
  width: 100%;
  height: 45%;
  background-image: url('~@/assets/advertise.jpg');
