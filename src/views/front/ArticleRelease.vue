      ...
      <div style="height: 60px;background-color: rgb(251,251,251);">
        ...
        <div class="release">
          ...
          <el-button type="primary"
                     style="width: 100px;height: 40px;border-radius: 23px;font-size: 14px;margin-left: 10px"
                     @click="handleEdit"><i class="el-icon-position"></i> 发布文章</el-button>
        ...
        <div class="touxiang">
          <el-dropdown style=" cursor: pointer; text-align: center"
            ...
            <el-dropdown-menu slot="dropdown"
              ...
              <router-link to="/front/editMaterial/ArticleCommand"
    ...
    <el-dialog title="文章信息"
      ...
      <el-form label-width="80px"
        ...
        <el-form-item label="文章类型">
          <el-select v-model="article.typeid"
                     placeholder="请选择">
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button style="width: 70px;height: 40px "
