  ...
  <div class="personalData">
    ...
    <div class="avaOfpersonalData">
      ...
      <div class="avaOf_avaOfpersonalData">
        <el-upload style="text-align: center;"
          ...
          <img v-if="allInforOfPerson.avatarUrl"
               :src="user.avatarUrl"
               class="avatar">
          <i v-else
    ...
    <div class="baseDataOfPersonalData">
      ...
      <div style=" flex: 2;display: flex;align-items: center;border-bottom: 1px solid #F2F2F2 ">
        ...
        <div v-if="!this.baseDataEdit"
             style=";flex:2">
          <div>
            <el-button type="primary"
                       round
                       @click="baseDataEditShow">确定修改</el-button>
          </div>
        </div>
      </div>
      <!--            表身-->
      <div class="showEditInforOfEditInfor"
           style="flex: 8;display: flex;flex-direction: column ;"
           v-if="!this.baseDataEdit">
        <div style="flex:1;display: flex;align-items: center;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13;letter-spacing: 2px;">
            <el-input v-model="allInforOfPerson.nickname"
        ...
        <div style="flex:1;display: flex;align-items: center;;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.id"
                      :disabled="true"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        ...
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.sex"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input type="textarea"
                      :rows="3"
                      v-model="allInforOfPerson.brief"
        ...
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.address"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.birthday"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
      ...
      <div class="showInforOfEditInfor"
           style="flex: 8;display: flex;flex-direction: column"
           v-if="this.baseDataEdit"
           @click="baseDataEditShowTwo">
        <div style="flex:1;display: flex;align-items: center;">
          <div style="flex:1; font-size: 14px;color: #555666;margin: 0px 40px;letter-spacing: 1px;">
            <span>用户昵称:</span>
          </div>
    ...
    <div class="eduOfPersonalData">
      ...
      <div style=" flex: 2; display: flex;align-items: center;border-bottom: 1px solid #F2F2F2 ">
        ...
        <div v-if="!this.eduDataEdit"
             style=";flex:2">
          <div>
            <el-button type="primary"
                       round
                       @click="eduDataEditShow">确定修改</el-button>
          </div>
        </div>
      </div>
      <!--            表身-->
      <div v-if="!eduDataEdit"
           class="eduInforDisShow"
           style="flex: 8;display: flex;flex-direction: column">
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          <div style="flex:1; font-size: 14px;color: #555666;margin: 0px 40px">
            <span>学校名称:</span>
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.nameofshcool"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.education"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.major"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
        <div style="flex:1;display: flex;align-items: center;letter-spacing: 1px;">
          ...
          <div style="font-size: 14px;color: #555666;flex: 13">
            <el-input v-model="allInforOfPerson.schooltime"
                      style="width: 100px;text-align: center"
                      placeholder="请输入内容"></el-input>
          </div>
        </div>
