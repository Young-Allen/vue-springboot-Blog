    ...
    <div style="display: block; margin-top:10px ;">
      <el-popconfirm confirm-button-text='确定'
        ...
        <el-button type="danger"
                   slot="reference"
                   style="margin-left: 10px">批量删除<i class="el-icon-close"
      ...
      <el-table-column prop="content"
        ...
        <template slot-scope="scope">
          <el-button type="primary"
                     @click="view(scope.row.content)">查看内容</el-button>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button type="warning"
                     @click="handleEdit(scope.row)">修改<i class="el-icon-edit"></i></el-button>
          <el-popconfirm confirm-button-text='确定'
                         cancel-button-text='我再想想'
                         icon="el-icon-info"
                         icon-color="red"
            ...
            <el-button type="danger"
                       ...
                       slot="reference">删除<i class="el-icon-close"></i></el-button>
          </el-popconfirm>
        </template>
      </el-table-column>
